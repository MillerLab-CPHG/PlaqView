...
*PlaqView* is a standalone, interactive, and reproducible Shiny- and R-based tool to explore single-cell RNA-sequencing data of human and mouse coronary artery samples. Our goal is to make these valuable data analytic tools publicly available to non-bioinformaticians. This is an open-sourced tool that is freely available and can be modified for other scRNA-seq data.

*Plaqview* is currently in public beta as of April 26 (v.1.0), 2021. Last Updated: Aug 29th, 2021.
...
eQTL/GWAS, multi-variate analysis and visualization with patient metadata. Cell-cell Communication and other intercellular and intracellular analysis tools are coming soon!
...
All scRNA-seq data submitted to *PlaqView* are processed in the same way. Please see the [Processing GitHub Page](https://github.com/MillerLab-CPHG/PlaqView) for scripts and details.

### Packages Used

*Seurat, Monocle3, Tidyverse, EnrichR, scCATCH, SingleR, Dynverse, Shiny.* See session info for detailed version and package history.
